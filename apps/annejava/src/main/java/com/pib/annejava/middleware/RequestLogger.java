...
package com.pib.annejava.middleware;

import com.pib.annejava.config.AppConfig;
import com.pib.annejava.utils.CpuMonitor;
import com.pib.annejava.utils.QueryUtils;
  ...
  */
  ...
  public Mono<Void> filter(ServerWebExchange serverWebExchange, 
    ...
    return webFilterChain.filter(serverWebExchange).doFinally(signalType -> {
      ...
      logData.put("LogName", "AnneJava.RequestLog");
      ...
      DistributionSummary
          .builder("AnneJavaDuration")
          .description("Histogram of AnneJava request duration")
          .tags(promTags)
          .register(promRegistry) // it won't not register everytime
          .record(duration);
      DistributionSummary
          .builder("AnneJavaSummary")
          .description("Summary of AnneJava request duration")
          .tags(promTags)
          .register(promRegistry) // it won't not register everytime
          .record(duration);
